...
- Introduces `klaviyo.safe_numeric_cast`, which preserves decimal and negative revenue values (e.g. refunds) across these adapters. BigQuery is unaffected because its `numeric` type already retains decimals by default.
